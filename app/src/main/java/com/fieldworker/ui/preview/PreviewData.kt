...
object PreviewData {
    ...
    val sampleTasks = listOf(
        Task(
            ...
            assignedUserId = 12,
            assignedUserName = "Иван Полевой",
            isPaid = true,
            paymentAmount = 3500.0,
            defectType = "Нет горячей воды",
            commentsCount = 2
        ),
        Task(
            id = 2,
            ...
            assignedUserId = 7,
            assignedUserName = "Алексей Соколов",
        ...
        Task(
            ...
            customerName = "ООО Балтика-Сервис",
            lat = 59.9012,
            lon = 30.2345,
        ...
        Task(
            ...
            assignedUserName = "Дежурная смена",
            defectType = "Прорыв трубы",
            commentsCount = 8
        )
    )
