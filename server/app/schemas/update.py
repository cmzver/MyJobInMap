...
class AppUpdateInfo(BaseModel):
    ...
    file_size: Optional[int] = Field(default=None, description="Размер APK файла в байтах")
...
class AppUpdateCheck(BaseModel):
    ...
    current_version: Optional[str] = Field(default=None, description="Текущая версия клиента")
    update: Optional[AppUpdateInfo] = Field(default=None, description="Информация об обновлении")
