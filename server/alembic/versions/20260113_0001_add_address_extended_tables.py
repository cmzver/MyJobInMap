...
def upgrade():
    ...
    op.create_index(
        "ix_address_systems_system_type", "address_systems", ["system_type"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["system_id"], ["address_systems.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_address_equipment_address_id", "address_equipment", ["address_id"]
    )
    op.create_index(
        "ix_address_equipment_system_id", "address_equipment", ["system_id"]
    )
    ...
    op.create_index(
        "ix_address_documents_address_id", "address_documents", ["address_id"]
    )
    ...
    op.create_index(
        "ix_address_contacts_address_id", "address_contacts", ["address_id"]
    )
