...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "category", sa.String(length=20), nullable=False, server_default="feedback"
        ),
    ...
    op.create_index(
        "ix_support_tickets_created_by_id",
        "support_tickets",
        ["created_by_id"],
        unique=False,
    )
    op.create_index(
        "ix_support_tickets_category", "support_tickets", ["category"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_support_tickets_organization_status",
        "support_tickets",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_support_tickets_updated_at", "support_tickets", ["updated_at"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        "ix_support_ticket_comments_id", "support_ticket_comments", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_support_ticket_comments_type",
        "support_ticket_comments",
        ["comment_type"],
        unique=False,
    )
...
def downgrade():
    op.drop_index(
        "ix_support_ticket_comments_type", table_name="support_ticket_comments"
    )
    op.drop_index(
        "ix_support_ticket_comments_created_at", table_name="support_ticket_comments"
    )
    op.drop_index(
        "ix_support_ticket_comments_ticket_id", table_name="support_ticket_comments"
    )
    ...
    op.drop_index(
        "ix_support_tickets_organization_status", table_name="support_tickets"
    )
